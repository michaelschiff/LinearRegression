...
object processData {
  def main() = {
    var stopWords:List[String] = List()//"to", "a", "of", "and", "the", "him", "her", "they", "that", "for", "is", "in", "it", "as", "with", "this", "you", "i", "are", "on", "his", "my", "an", "he", "she", "their", "who", "has", "by", "from", "or", "into", "at", "be", "all", "which", "well")
